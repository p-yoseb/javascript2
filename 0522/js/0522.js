...
var 학생2=new Student("장동건",50,50,20,40);

var 학생3=new Student("이정재",50,50,50,40);
var 학생4=new Student("호호호",50,50,50,50);

// 프로토타입을 사용하는 이유는 메모리 절약
// 프로토타입은 공통영역에 메소드를 할당 -> 힙(heap)
...
document.write("평균 : " + 학생1.getAvg()+"<br>");
...
document.write("<br>")
document.write("원의 면적 : "+cir.getArea());
...
var cir2=new Circle2(8)
document.write("<br>");
document.write("원의 면적 : "+cir2.getArea());
document.write("<br>");
document.write("circle2의 부모는?" + cir2 instanceof Circle2);
document.write("circle의 부모는?" + cir instanceof Circle);
...
Father.재산="2억";
document.write(`<h2> 아버지재산 : ${Father.재산} </h2>`);
