...
localFunc();
// console.log("함수 바깥에서" + msg); // msg undefined
// 지역변수는 함수내에서만 사용할 수 있다.

var msg="hi everyone"; // 전역변수
function localFunc(){
    msg="welcome"; // 전역변수값이 재정의
    console.log("함수내에서" + msg);
}
localFunc();
...
// 일반함수는 선언과 동시에 호이스팅된다.(문서상단으로 이동) (hoisting)
...
myFunc1();
// 함수선언하면 초기 모든 함수들을 콜스택영역이라는 곳에 모아서 생성된다.
