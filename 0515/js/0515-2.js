...
// const 수학=prompt("수학몇점?");
// const 영어=prompt("영어몇점?");
// const 결과=(parseInt(수학)+parseInt(영어))/2;
// console.log(결과);
...
// OR는 하나만 참이면 결과가 참이다. 모두거짓 -> 거짓
// AND는 하나만 거짓이면 결과가 거짓이다. 모두참 -> 참
...
var num2=20;
// ++ --
console.log(num1++); // 후위, 저장하고 증가. 10 -> 11
console.log(++num1); // 선위, 증거하고 저장.
